...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName,
		...
		WebElement firstName_ele = eleUtil.waitForElementVisible(this.firstName, Constants.DEFAULT_ELEMENT_TIMEOUT);
		firstName_ele.clear();
		...
		String successMesg = eleUtil.waitForElementVisible(registerSuccessMesg, Constants.DEFAULT_TIMEOUT).getText();
